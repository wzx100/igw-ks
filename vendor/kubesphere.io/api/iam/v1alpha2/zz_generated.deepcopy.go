...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GolbalSpec) DeepCopyInto(out *GolbalSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GolbalSpec.
func (in *GolbalSpec) DeepCopy() *GolbalSpec {
	if in == nil {
		return nil
	}
	out := new(GolbalSpec)
